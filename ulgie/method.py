...
from ulgie.params import SlotAttentionParams
from ulgie.utils import Tensor
from ulgie.utils import to_rgb_from_tensor
...
class SlotAttentionMethod(pl.LightningModule):
    ...
    def sample_images(self):
        ...
        recon_combined, recons_pre, recons, slots = self.model.forward(batch)
        ...
        images = vutils.make_grid(
            out.reshape(batch_size * out.shape[0], C, H, W).cpu(), normalize=False, nrow=out.shape[1],
        )
